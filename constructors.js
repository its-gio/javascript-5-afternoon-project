...
// { id: 1, title: "Mad Max: Furry Road", rating: 5 }
User.prototype.addSavedPost = function(id, title, rating) {
  let temp = [...this.savedPosts, {id, title, rating}]
  this.savedPosts = temp;
  return this.savedPosts;
};

let Gio = new User("Gio", 26, "fake@email.com", []);
...
User.prototype.changePostRating = function(id, newRate) {
  const target = this.savedPosts.findIndex(post => post.id === id);
  this.savedPosts[target].rating = newRate;
}